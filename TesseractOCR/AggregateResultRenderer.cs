...
namespace TesseractOCR
{
    ...
    /// </summary>
    public class AggregateResultRenderer : DisposableBase, IResult
    {
        #region Fields
        ...
        public AggregateResultRenderer(params IResult[] resultRenderers) : this((IEnumerable<IResult>)resultRenderers)
        {
        }
        ...
        /// </summary>
        /// <param name="resultRenderers">The child result renderers.</param>
        public AggregateResultRenderer(IEnumerable<IResult> resultRenderers)
        {
